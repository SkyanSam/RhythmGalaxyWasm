...
namespace TweenSharp.Factory
{
    public static class TweenFactory
    {
        ...
        public static TweenTarget<T, TValue> Tween<T, TValue>(this T target, Expression<Func<T, TValue>> expression, TweenProgress.ProgressFunction<TValue> progressFunction)
        {
            ...
            if (memberExpression != null)
            {
                return new TweenTarget<T, TValue>(target, memberExpression, progressFunction);
